				...
				<div class="container clearfix">
					...
					<div class="col_half col_last tright">
						<div class="fright clearfix">
							...
							<a target="_blank" href="https://twitter.com/ShaikRafikhan1" class="social-icon si-small si-borderless si-twitter">
								<i class="icon-twitter"></i>
								<i class="icon-twitter"></i>
							</a>

							<a target="_blank" href="https://www.youtube.com/@ShaikRafikhan/featured" class="social-icon si-small si-borderless si-youtube">
							...
							<a target="_blank" href="https://github.com/rafi7391" class="social-icon si-small si-borderless si-github">
